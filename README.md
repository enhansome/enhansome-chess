...
* [Stockfish Chess Repo](https://github.com/official-stockfish/Stockfish) ⭐ 16,663 | 🐛 45 | 🌐 C++ | 📅 2026-09-13 - UCI chess engine. Repo on GitHub.
* [Leela Chess Zero](https://github.com/LeelaChessZero/lc0) ⭐ 3,217 | 🐛 252 | 🌐 C++ | 📅 2026-09-12 - A free, open-source, and neural network-based chess engine and distributed computing project.
* [Caissa](https://github.com/Witek902/Caissa) ⭐ 112 | 🐛 6 | 🌐 C++ | 📅 2026-09-17 - A strong, UCI command-line chess engine, written from scratch in C++ in development since early 2021. Optimized for regular chess, FRC (Fischer Random Chess) and DFRC (Double Fischer Random Chess).
...
* [chess.js](https://github.com/jhlywa/chess.js) ⭐ 4,405 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-11 - A JavaScript chess library for chess move generation/validation, piece placement/movement, and check/checkmate/draw detection.
...
* [Lila](https://github.com/ornicar/lila) ⭐ 18,741 | 🐛 1,250 | 🌐 Scala | 📅 2026-09-18 - A free online chess game server focused on realtime gameplay and ease of use.
* [python-chess](https://github.com/niklasf/python-chess) ⭐ 2,880 | 🐛 49 | 🌐 Python | 📅 2026-08-22 - A chess library for Python, with move generation and validation, PGN parsing and writing, Polyglot opening book reading, Gaviota tablebase probing, Syzygy tablebase probing, and UCI/XBoard engine communication.
...
* [PyChess](https://github.com/pychess/pychess) ⭐ 810 | 🐛 92 | 🌐 Python | 📅 2026-09-18 - A chess client for Linux/Windows.
...
* [WintrChess](https://github.com/WintrCat/wintrchess) ⭐ 255 | 🐛 30 | 🌐 TypeScript | 📅 2026-04-24 - A website that analyses Chess games with move classifications.
