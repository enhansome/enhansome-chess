...
* [Stockfish Chess Repo](https://github.com/official-stockfish/Stockfish) ⭐ 16,437 | 🐛 40 | 🌐 C++ | 📅 2026-08-29 - UCI chess engine. Repo on GitHub.
...
* [chess.js](https://github.com/jhlywa/chess.js) ⭐ 4,392 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-11 - A JavaScript chess library for chess move generation/validation, piece placement/movement, and check/checkmate/draw detection.
...
* [Lila](https://github.com/ornicar/lila) ⭐ 18,689 | 🐛 1,277 | 🌐 Scala | 📅 2026-08-30 - A free online chess game server focused on realtime gameplay and ease of use.
* [python-chess](https://github.com/niklasf/python-chess) ⭐ 2,866 | 🐛 49 | 🌐 Python | 📅 2026-08-22 - A chess library for Python, with move generation and validation, PGN parsing and writing, Polyglot opening book reading, Gaviota tablebase probing, Syzygy tablebase probing, and UCI/XBoard engine communication.
...
* [WintrChess](https://github.com/WintrCat/wintrchess) ⭐ 244 | 🐛 29 | 🌐 TypeScript | 📅 2026-04-24 - A website that analyses Chess games with move classifications.
