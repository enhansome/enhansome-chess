...
* [Stockfish Chess Repo](https://github.com/official-stockfish/Stockfish) ⭐ 16,487 | 🐛 49 | 🌐 C++ | 📅 2026-09-05 - UCI chess engine. Repo on GitHub.
* [Leela Chess Zero](https://github.com/LeelaChessZero/lc0) ⭐ 3,199 | 🐛 257 | 🌐 C++ | 📅 2026-09-05 - A free, open-source, and neural network-based chess engine and distributed computing project.
* [Caissa](https://github.com/Witek902/Caissa) ⭐ 110 | 🐛 8 | 🌐 C++ | 📅 2026-09-04 - A strong, UCI command-line chess engine, written from scratch in C++ in development since early 2021. Optimized for regular chess, FRC (Fischer Random Chess) and DFRC (Double Fischer Random Chess).
...
* [chessboardjs](https://github.com/oakmac/chessboardjs/) ⭐ 2,132 | 🐛 109 | 🌐 JavaScript | 📅 2024-04-17 - JavaScript chessboard, repo on GitHub.
...
* [Lila](https://github.com/ornicar/lila) ⭐ 18,704 | 🐛 1,266 | 🌐 Scala | 📅 2026-09-05 - A free online chess game server focused on realtime gameplay and ease of use.
* [python-chess](https://github.com/niklasf/python-chess) ⭐ 2,871 | 🐛 51 | 🌐 Python | 📅 2026-08-22 - A chess library for Python, with move generation and validation, PGN parsing and writing, Polyglot opening book reading, Gaviota tablebase probing, Syzygy tablebase probing, and UCI/XBoard engine communication.
...
* [WintrChess](https://github.com/WintrCat/wintrchess) ⭐ 248 | 🐛 29 | 🌐 TypeScript | 📅 2026-04-24 - A website that analyses Chess games with move classifications.
