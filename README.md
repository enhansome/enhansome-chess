...
* [English](https://github.com/mbiesiad/awesome-chess) ⭐ 59 | 🐛 10 | 📅 2025-11-18
* [Polish](https://github.com/mbiesiad/awesome-chess/tree/pl_PL) ⭐ 59 | 🐛 10 | 📅 2025-11-18

## Chess engines

* [Stockfish Chess Repo](https://github.com/official-stockfish/Stockfish) ⭐ 16,477 | 🐛 50 | 🌐 C++ | 📅 2026-09-04 - UCI chess engine. Repo on GitHub.
* [Leela Chess Zero](https://github.com/LeelaChessZero/lc0) ⭐ 3,198 | 🐛 256 | 🌐 C++ | 📅 2026-05-05 - A free, open-source, and neural network-based chess engine and distributed computing project.
* [Caissa](https://github.com/Witek902/Caissa) ⭐ 110 | 🐛 8 | 🌐 C++ | 📅 2026-09-03 - A strong, UCI command-line chess engine, written from scratch in C++ in development since early 2021. Optimized for regular chess, FRC (Fischer Random Chess) and DFRC (Double Fischer Random Chess).
...
* [official-stockfish/books](https://github.com/official-stockfish/books) ⭐ 183 | 🐛 5 | 🌐 Python | 📅 2026-04-08 - Chess books used to develop Stockfish.
...
* [chessboardjs](https://github.com/oakmac/chessboardjs/) ⭐ 2,134 | 🐛 109 | 🌐 JavaScript | 📅 2024-04-17 - JavaScript chessboard, repo on GitHub.
* [jchess](https://github.com/bmarini/jchess) ⭐ 83 | 🐛 9 | 🌐 TypeScript | 📅 2026-04-07 - A jQuery-based JavaScript library for parsing and displaying chess games, repo on GitHub.
* [chessboard-js](https://github.com/caustique/chessboard-js) ⭐ 38 | 🐛 7 | 🌐 JavaScript | 📅 2018-08-13 - Repo on GitHub, responsive mobile-first JavaScript chessboard library.
* [chess-board](https://github.com/laat/chess-board) ⭐ 21 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-13 - A web component for displaying chess positions, repo on GitHub.
...
* [chess.js](https://github.com/jhlywa/chess.js) ⭐ 4,394 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-11 - A JavaScript chess library for chess move generation/validation, piece placement/movement, and check/checkmate/draw detection.
...
* [Lila](https://github.com/ornicar/lila) ⭐ 18,702 | 🐛 1,275 | 🌐 Scala | 📅 2026-09-04 - A free online chess game server focused on realtime gameplay and ease of use.
* [python-chess](https://github.com/niklasf/python-chess) ⭐ 2,870 | 🐛 49 | 🌐 Python | 📅 2026-08-22 - A chess library for Python, with move generation and validation, PGN parsing and writing, Polyglot opening book reading, Gaviota tablebase probing, Syzygy tablebase probing, and UCI/XBoard engine communication.
...
* [PyChess](https://github.com/pychess/pychess) ⭐ 808 | 🐛 103 | 🌐 Python | 📅 2026-09-03 - A chess client for Linux/Windows.
* [Tensorflow\_chessbot](https://github.com/Elucidation/tensorflow_chessbot) ⭐ 568 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2023-07-25 - Predict chessboard FEN layouts from images using TensorFlow.
* [Command Line Chess](https://github.com/marcusbuffett/command-line-chess) ⭐ 532 | 🐛 13 | 🌐 Python | 📅 2026-04-13 - A Python program to play chess against an AI in the terminal.
...
* [WintrChess](https://github.com/WintrCat/wintrchess) ⭐ 247 | 🐛 29 | 🌐 TypeScript | 📅 2026-04-24 - A website that analyses Chess games with move classifications.
...
* [AndroidChessClock](https://github.com/johnwilde/AndroidChessClock) ⭐ 8 | 🐛 1 | 🌐 Kotlin | 📅 2019-02-04 - Simple chess clock for Android.
...
* [Chess Pursuit](https://github.com/Saturnyn/ChessPursuit) ⭐ 299 | 🐛 11 | 🌐 JavaScript | 📅 2020-05-29 - The project where idea was to turn the chess game upside down, making it an action game instead of a strategy game.
