...
* [Stockfish Chess Repo](https://github.com/official-stockfish/Stockfish) ⭐ 16,603 | 🐛 42 | 🌐 C++ | 📅 2026-09-13 - UCI chess engine. Repo on GitHub.
* [Leela Chess Zero](https://github.com/LeelaChessZero/lc0) ⭐ 3,209 | 🐛 249 | 🌐 C++ | 📅 2026-09-12 - A free, open-source, and neural network-based chess engine and distributed computing project.
...
* [Lila](https://github.com/ornicar/lila) ⭐ 18,724 | 🐛 1,251 | 🌐 Scala | 📅 2026-09-13 - A free online chess game server focused on realtime gameplay and ease of use.
* [python-chess](https://github.com/niklasf/python-chess) ⭐ 2,876 | 🐛 49 | 🌐 Python | 📅 2026-08-22 - A chess library for Python, with move generation and validation, PGN parsing and writing, Polyglot opening book reading, Gaviota tablebase probing, Syzygy tablebase probing, and UCI/XBoard engine communication.
