...
* [English](https://github.com/mbiesiad/awesome-chess) ⭐ 60 | 🐛 13 | 📅 2025-11-18
* [Polish](https://github.com/mbiesiad/awesome-chess/tree/pl_PL) ⭐ 60 | 🐛 13 | 📅 2025-11-18

## Chess engines

* [Stockfish Chess Repo](https://github.com/official-stockfish/Stockfish) ⭐ 16,736 | 🐛 42 | 🌐 C++ | 📅 2026-09-22 - UCI chess engine. Repo on GitHub.
* [Leela Chess Zero](https://github.com/LeelaChessZero/lc0) ⭐ 3,226 | 🐛 251 | 🌐 C++ | 📅 2026-09-19 - A free, open-source, and neural network-based chess engine and distributed computing project.
* [Caissa](https://github.com/Witek902/Caissa) ⭐ 114 | 🐛 7 | 🌐 C++ | 📅 2026-09-26 - A strong, UCI command-line chess engine, written from scratch in C++ in development since early 2021. Optimized for regular chess, FRC (Fischer Random Chess) and DFRC (Double Fischer Random Chess).
...
* [Lila](https://github.com/ornicar/lila) ⭐ 18,767 | 🐛 1,266 | 🌐 Scala | 📅 2026-09-26 - A free online chess game server focused on realtime gameplay and ease of use.
* [python-chess](https://github.com/niklasf/python-chess) ⭐ 2,884 | 🐛 51 | 🌐 Python | 📅 2026-08-22 - A chess library for Python, with move generation and validation, PGN parsing and writing, Polyglot opening book reading, Gaviota tablebase probing, Syzygy tablebase probing, and UCI/XBoard engine communication.
...
* [PyChess](https://github.com/pychess/pychess) ⭐ 812 | 🐛 85 | 🌐 Python | 📅 2026-09-26 - A chess client for Linux/Windows.
